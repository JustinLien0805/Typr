...
export default function AuthPanel() {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 w-[min(22rem,calc(100vw-2rem))] rounded-2xl border border-white/10 bg-black/70 backdrop-blur-md px-4 py-3 text-white shadow-[0_12px_40px_rgba(0,0,0,0.35)]">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-[10px] uppercase tracking-[0.28em] text-white/45">Account</p>
          {loading ? (
